...
'''
    Here are writen four functions, each one applying a different method of outlier removal:
     remove_outliers_zscore()
     remove_outliers_iqr()
     remove_outliers_isolation_forest()
     remove_outliers_gradient_boost()
'''
...
#----------------------------------------------------------------------------------
def remove_outliers_zscore(df, threshold=None, path=None):
...
#                                IQR Outlier Removal                               |
#-----------------------------------------------------------------------------------
def remove_outliers_iqr(df, multiplier=None, path=None):
    # Separate continuous features
    continuous_features = df.select_dtypes(include=['float64', 'int64']).columns
